...
/**
 * Created by Sasikanth on 3/5/15.
 */
...
public class KeywordsFlow extends FrameLayout implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public static final long ANIM_DURATION = 600l;
    ...
    private void init() {
        ...
        //interpolator = AnimationUtils.loadInterpolator(getContext(), new DecelerateInterpolator());
